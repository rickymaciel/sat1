/*
 * UIListarFacturas.java
 *
 * Created on 10 de enero de 2008, 18:42
 */
 ...
 */
public class UIListarFacturas extends javax.swing.JFrame
{
    
    /** Creates new form UIListarFacturas */
    public UIListarFacturas()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "Orden", "Numero Factura", "Fecha", "Matriculado"
            }
        )
        {
...
// TODO add your handling code here:
        UIVerFactura ver = new UIVerFactura();
        ver.setVisible(true);
...
//this.cargarComboDesde();
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new UIListarFacturas().setVisible(true);
            }
        });
    }
