/*
 * UINuevoTipoSeccion.java
 *
 * Created on 8 de enero de 2008, 12:20
 */
 ...
 */
public class UINuevoTipoSeccion extends javax.swing.JFrame
{
    private Collection secciones = new ArrayList();
    private boolean guardar = false;
    
    /** Creates new form UINuevoTipoSeccion */
    public UINuevoTipoSeccion()
    {
        initComponents();
        ...
        //Fin del centrado
                this.llenarTabla(new TipoSeccion());
    }
    ...
    private void initComponents() {
        ...
        jTNombreTipoSeccion = new javax.swing.JTextField();
        ...
        setTitle("Administrar Tipo de Nivel");
        setResizable(false);
        ...
        jTNombreTipoSeccion.setToolTipText("Ingrese letras para realizar un filtrado del listado.");
        jTNombreTipoSeccion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTNombreTipoSeccionKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTNombreTipoSeccionKeyReleased(evt);
            }
        });

        jBGuardar.setText("Guardar");
        jBGuardar.setToolTipText("Guarda el nuevo tipo de seccion");
        ...
        jTNombre1.setToolTipText("Ingrese un nombre de Seccion Valida.");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTNombre1, javax.swing.GroupLayout.DEFAULT_SIZE, 274, Short.MAX_VALUE)))
                .addContainerGap())
        );
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTNombreTipoSeccion))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTNombreTipoSeccion, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jTNombreTipoSeccionKeyReleased(java.awt.event.KeyEvent evt)//GEN-FIRST:event_jTNombreTipoSeccionKeyReleased
    {//GEN-HEADEREND:event_jTNombreTipoSeccionKeyReleased
// TODO add your handling code here:
        this.filtrar(this.jTNombreTipoSeccion.getText().trim().toUpperCase());
    }//GEN-LAST:event_jTNombreTipoSeccionKeyReleased
...
// cuando se seleccione una fila, los datos de esa fila deben aparecer en los textbox de abajo solo si no se esta por cargar un nuevo elemento
        if(!this.guardar)
        {
            ...
            while(it.hasNext())
            {
                t = (TipoSeccion)it.next();
                if(t.getIdtipoSeccion() == Integer.parseInt(String.valueOf(this.jTable1.getValueAt(this.jTable1.getSelectedRow(),0))))
                {
                    this.jTCodigo.setText(String.valueOf(t.getIdtipoSeccion()));
...
// TODO add your handling code here:
    ...
    private void jBImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBImprimirMouseClicked
        // TODO add your handling code here:
        cExport_thread report = new cExport_thread(18);
        report.start();
    ...
    private void jTNombreTipoSeccionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTNombreTipoSeccionKeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==27)
            this.dispose();
    }//GEN-LAST:event_jTNombreTipoSeccionKeyPressed
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new UINuevoTipoSeccion().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTNombreTipoSeccion;
    ...
    {
     TipoSeccion tipo = new TipoSeccion();
    ...
    private void modificar()
    {
     TipoSeccion tipo = new TipoSeccion();
     tipo.setNombre(this.jTNombre1.getText().toUpperCase().trim());
     tipo.setIdtipoSeccion(Integer.parseInt(this.jTCodigo.getText()));
     tipo.setExiste("S");
     this.jBGuardar.setEnabled(false);
     this.guardar = false;
    ...
    private void llenarTabla(TipoSeccion t)
    {
        ...
        {
            t = (TipoSeccion)it.next();
            datos[0] = String.valueOf(t.getIdtipoSeccion());
            datos[1] = t.getNombre();            
            modelo.addRow(datos);
        }
        t = null;
    ...
    private void borrarRegistro(int fila)
    {
        ...
        while(it.hasNext())
        {
            TipoSeccion p = (TipoSeccion)it.next();
            if(p.getIdtipoSeccion() == Integer.parseInt(String.valueOf(this.jTable1.getValueAt(fila,0))))
            {
                Baja baja = new Baja();
                int respuesta = baja.eliminar(p);
                baja = null;
                if(respuesta == 0)
                    JOptionPane.showMessageDialog(null,"Error al dar de baja el tipo de seccion","Error",JOptionPane.ERROR_MESSAGE);
                else
                    JOptionPane.showMessageDialog(null,"El tipo de seccion se elimino correctamente","Baja Completada",JOptionPane.INFORMATION_MESSAGE);
            }
            p = null;
        }
        it = null;
