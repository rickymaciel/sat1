 ...
 * UIDepartamento.java
 *
 * Created on 8 de enero de 2008, 09:59
 */
 ...
 * @author  pazyarmonia
 */
public class UIDepartamento extends javax.swing.JFrame 
{
	...
	this.setLocation(((pantalla.width - cuadro.width)/2), (pantalla.height - cuadro.height)/2);
        this.llenarTabla(new Departamento());
        this.llenarCombo();
    }
    ...
    private void initComponents() {
        ...
        jTNombreDepartamento1 = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        jBAgregarProvincia = new javax.swing.JButton();
        ...
        jLNombre.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jLNombreKeyPressed(evt);
            }
        });

        jTNombreDepartamento.setToolTipText("ingrese letras para realizar un filtrado del listado.");
        jTNombreDepartamento.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTNombreDepartamentoKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTNombreDepartamentoKeyReleased(evt);
            }
        });
        ...
        jComboBox1.setToolTipText("provincia a la cual pertenece el departamento.");
        ...
        jTCodigo.setToolTipText("Este codigo se genera automaticamente.");
        ...
        jTNombreDepartamento1.setToolTipText("ingrese un nombre de departamento valido.");
        jTNombreDepartamento1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTNombreDepartamento1KeyPressed(evt);
            }
        });
        ...
        jBAgregarProvincia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/agregar.gif"))); // NOI18N
        jBAgregarProvincia.setToolTipText("imprimir un reporte del listado completo de productos.");
        jBAgregarProvincia.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jBAgregarProvinciaMouseClicked(evt);
            }
        });
        jBAgregarProvincia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBAgregarProvinciaActionPerformed(evt);
            }
        });
        jBAgregarProvincia.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jBAgregarProvinciaKeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jTCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTNombreDepartamento1, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jBAgregarProvincia, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTNombreDepartamento1, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jBAgregarProvincia, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(43, 43, 43))
        );
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTNombreDepartamento))
...
// TODO add your handling code here:
    ...
    private void jTNombreDepartamentoKeyReleased(java.awt.event.KeyEvent evt)//GEN-FIRST:event_jTNombreDepartamentoKeyReleased
    {//GEN-HEADEREND:event_jTNombreDepartamentoKeyReleased
// TODO add your handling code here:
        this.filtrar(this.jTNombreDepartamento.getText().toUpperCase().trim());
    }//GEN-LAST:event_jTNombreDepartamentoKeyReleased
...
// TODO add your handling code here:
        ...
        if(evt.getKeyCode()==10)
        {
            ...
            this.jTNombreDepartamento1.setText("");
        }
...
// TODO add your handling code here:
        ...
        this.jTCodigo.setText("");
        this.jTNombreDepartamento1.setText("");
        this.jTNombreDepartamento1.requestFocus();
    }//GEN-LAST:event_jBNuevoActionPerformed

    private void jTNombreDepartamento1KeyPressed(java.awt.event.KeyEvent evt)//GEN-FIRST:event_jTNombreDepartamento1KeyPressed
    {//GEN-HEADEREND:event_jTNombreDepartamento1KeyPressed
// TODO add your handling code here:
        if(evt.getKeyCode()==27)
            this.dispose();
        
    }//GEN-LAST:event_jTNombreDepartamento1KeyPressed
...
// cuando se seleccione una fila, los datos de esa fila deben aparecer en los textbox de abajo solo si no se esta por cargar un nuevo elemento
        if(!this.guardar)
        {
            ...
            while(it.hasNext())
            {
                ...
                if(d.getIddepartamento() == Integer.parseInt(String.valueOf(this.jTable1.getValueAt(this.jTable1.getSelectedRow(),0))))
                {
                    this.jTCodigo.setText(String.valueOf(d.getIddepartamento()));
                    this.jTNombreDepartamento1.setText(d.getNombre());
                    this.jComboBox1.setSelectedItem(d.getProvincia().getNombre());
                }
            }
        }
...
private void jLNombreKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jLNombreKeyPressed
    // TODO add your handling code here:
    if(evt.getKeyCode()==27)
        this.dispose();
}//GEN-LAST:event_jLNombreKeyPressed
...
// TODO add your handling code here:
    ...
    private void jBImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBImprimirMouseClicked
        // TODO add your handling code here:
        cExport_thread report = new cExport_thread(2);
        report.start();
    ...
    private void jBAgregarProvinciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBAgregarProvinciaMouseClicked
        // TODO add your handling code here:
}//GEN-LAST:event_jBAgregarProvinciaMouseClicked

    private void jBAgregarProvinciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgregarProvinciaActionPerformed
        // TODO add your handling code here:
        UINuevaProvincia ventanaProvincia=new UINuevaProvincia();
        ventanaProvincia.setVisible(true);
}//GEN-LAST:event_jBAgregarProvinciaActionPerformed

    private void jBAgregarProvinciaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBAgregarProvinciaKeyPressed
        // TODO add your handling code here:
}//GEN-LAST:event_jBAgregarProvinciaKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UIDepartamento().setVisible(true);
            }
        });
    }
    
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jBAgregarProvincia;
    ...
    private javax.swing.JTextField jTNombreDepartamento1;
    ...
    {
        int control = 0;
        if(this.jTNombreDepartamento1.getText().trim().length()==0)
            control = 1;
        return control;
    }
    ...
    private void guardar()
    {
        ...
        String nombreLocalidad = (String) this.jComboBox1.getSelectedItem();
        Iterator it = provincias.iterator();
        Provincia provincia = new Provincia();
        while(it.hasNext())
        {
            Provincia p = (Provincia)it.next();
            if(nombreLocalidad.equals(p.getNombre()))
            {
                provincia = p;
                bandera++;
            }
        ...
        departamento.setExiste("S");
        departamento.setNombre(this.jTNombreDepartamento1.getText().toUpperCase().trim());
        departamento.setProvincia(provincia);
        this.guardar = false;
        this.jBGuardar.setEnabled(false);
        // aqui va el codigo que guarda en la base de datos
        CAlta alta = new CAlta();
        int respuesta = alta.hacerAlta(departamento);
        if(respuesta != 0)
    ...
    private void modificar()
    {
        ...
        departamento.setNombre(this.jTNombreDepartamento1.getText().toUpperCase().trim());
        departamento.setProvincia(provincia);
        departamento.setIddepartamento(Integer.parseInt(this.jTCodigo.getText()));
        this.guardar = false;
        this.jBGuardar.setEnabled(false);
        // aqui va el codigo que guarda en la base de datos
        Modificacion mod = new Modificacion();
        int respuesta = mod.modificar(departamento);
        if(respuesta == 0)
                JOptionPane.showMessageDialog(null,"Error en la carga de datos","Eroor",JOptionPane.ERROR_MESSAGE);
        else
    ...
    private void llenarTabla(Departamento d)
    {
        ...
        {
            d = (Departamento)it.next();
            datos[0] = String.valueOf(d.getIddepartamento());
            datos[1] = d.getNombre();
            datos[2] = d.getProvincia().getNombre();
            modelo.addRow(datos);
        }
    }
    ...
    {
        // de alguna forma obtengo todas las provincias cargadas en la base de datos
        //provincias = algo;
        CListar listar = new CListar();
    ...
    {
        this.jTCodigo.setText("");
        this.jTNombreDepartamento.setText("");
        this.jTNombreDepartamento1.setText("");
    }
    ...
    private void borrarRegistro(int fila)
    {
        ...
        while(it.hasNext())
        {
            ...
            if(d.getIddepartamento() == Integer.parseInt(String.valueOf(this.jTable1.getValueAt(fila,0))))
            {
                Baja baja = new Baja();
                int respuesta = baja.eliminar(d);
                baja = null;
                if(respuesta == 0)
