/*
 * UIEntidadesExternas.java
 *
 * Created on 8 de enero de 2008, 11:28
 */
 ...
 * @author  pazyarmonia
 */
public class UIEntidadesExternas extends javax.swing.JFrame 
{
    private Collection entidades = new ArrayList();
    private boolean guardar = false;
    
    /** Creates new form UIEntidadesExternas */
    public UIEntidadesExternas() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTNombreEntidad1 = new javax.swing.JTextField();
        ...
        setTitle("Administrar Entidades Externas");
        setResizable(false);
        ...
        jTextField1.setToolTipText("Ingrese letras para realizar un filtrado del listado.");
        ...
        jTNombreEntidad1.setToolTipText("Ingrese un nombre valido.");
        jTNombreEntidad1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTNombreEntidad1KeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTNombreEntidad1, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTNombreEntidad1, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
// TODO add your handling code here:
        this.filtrar(this.jTextField1.getText().toUpperCase().trim());
...
// TODO add your handling code here:
    ...
    private void jTNombreEntidad1KeyPressed(java.awt.event.KeyEvent evt)//GEN-FIRST:event_jTNombreEntidad1KeyPressed
    {//GEN-HEADEREND:event_jTNombreEntidad1KeyPressed
// TODO add your handling code here:
        if(evt.getKeyCode()==27)
            this.dispose();
    }//GEN-LAST:event_jTNombreEntidad1KeyPressed
        ...
        if(!this.guardar)
        {
            ...
            while(it.hasNext())
            {
                ...
                if(e.getIdentidadExterna() == Integer.parseInt(String.valueOf(this.jTable1.getValueAt(this.jTable1.getSelectedRow(),0))))
                {
                    ...
                    this.jTNombreEntidad1.setText(e.getNombre().trim());
                }
            }
        }
...
// TODO add your handling code here:
    ...
    private void jBImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBImprimirMouseClicked
        // TODO add your handling code here:
        cExport_thread report = new cExport_thread(24);
        report.start();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UIEntidadesExternas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTNombreEntidad1;
    ...
    private int controlar()
    {
        ...
        if(this.jTNombreEntidad1.getText().trim().length() == 0)
            control = 1;
        return control;
    }
    ...
    {
        EntidadExterna e = new EntidadExterna();
        e.setNombre(this.jTNombreEntidad1.getText().toUpperCase().trim());
        e.setExiste("S");
    ...
    private void modificar()
    {
        ...
        e.setNombre(this.jTNombreEntidad1.getText().toUpperCase().trim());
        e.setExiste("S");
        e.setIdentidadExterna(Integer.parseInt(this.jTCodigo.getText()));
    ...
    private void borrarRegistro(int fila)
    {
        ...
        while(it.hasNext())
        {
            EntidadExterna e = (EntidadExterna)it.next();
            if(e.getIdentidadExterna()==Integer.parseInt(String.valueOf(this.jTable1.getValueAt(fila,0))))
            {
                Baja baja = new Baja();
                ...
                if(respuesta == 0)
                    ...
                    JOptionPane.showMessageDialog(null,"Se elimino correctamente el registro","Baja Completada",JOptionPane.INFORMATION_MESSAGE);
            }
            e = null;
        }
        it = null;
